...
const white_elements: NodeListOf<Element> = navbar.querySelectorAll(".text-white");
const white_bg_elements: NodeListOf<Element> = navbar.querySelectorAll("[sidenav-trigger] i.bg-white");
const white_before_elements: NodeListOf<Element> = navbar.querySelectorAll(".before\\:text-white");

window.onscroll = function () {
  let blur: string = navbar.getAttribute("navbar-scroll");
